...
Feature: The starred courses block
  ...
  Scenario: Confirming settings defaults
    ...
    Then the field "s__block_starred_courses_exclude_starred_from_recent" matches value "1"
  ...
  Scenario: Exclude starred from recent
    ...
    Given the following config values are set as admin:
      ...
      | block_starred_courses_exclude_starred_from_recent | 1     |
    ...
    Then I should see "Starred Courses" in the ".block_starred_courses .card-text.content" "css_element"
    Then I should not see "Recent Courses" in the ".block_starred_courses .card-text.content" "css_element"
    ...
    Given the following config values are set as admin:
      | name                                              | value |
      | block_starred_courses_exclude_starred_from_recent | 0     |

    # But now we should see the title, because all the courses should show up under recent as well as starred
    And I reload the page
    Then I should see "Starred Courses" in the ".block_starred_courses .card-text.content" "css_element"
    Then I should see "Recent Courses" in the ".block_starred_courses .card-text.content" "css_element"
    Then I should see "Course One" in the ".block_starred_courses" "css_element"
    Then I should see "Course Two" in the ".block_starred_courses" "css_element"
    Then I should see "Course Three" in the ".block_starred_courses" "css_element"
